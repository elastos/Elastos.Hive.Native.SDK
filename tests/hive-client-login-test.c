...
static void test_hive_client_close_without_logout(void)
{
    int rc;
    HiveClient *client;
...
static void test_hive_client_double_login_logout(void)
{
    int rc;
    HiveClient *client;
...
static void test_hive_client_login_logout(void)
{
    int rc;
    HiveClient *client;
...
static CU_TestInfo cases[] = {
    ...
    {   "test_hive_client_close_without_logout", test_hive_client_close_without_logout },
    {   "test_hive_client_double_login_logout",  test_hive_client_double_login_logout  },
    {   "test_hive_client_login_logout",         test_hive_client_login_logout         },
    {   NULL,                                    NULL                                  }
};
