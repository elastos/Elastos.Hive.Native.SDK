...
static void test_dup_logout(void)
{
    int rc;
    HiveClientInfo info;
    HiveDrive *drive;
...
static CU_TestInfo cases[] = {
        ...
        { "test_dup_logout", test_dup_logout },
        { NULL, NULL }
};

CU_TestInfo *logout_test_get_cases(void)
{
    return cases;
}

int onedrive_logout_test_suite_init(void)
{
...
int onedrive_logout_test_suite_cleanup(void)
{
...
int ipfs_logout_test_suite_init(void)
{
...
int ipfs_logout_test_suite_cleanup(void)
{
    test_context_cleanup();
